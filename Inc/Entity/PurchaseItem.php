    ...
    class PurchaseItem extends BaseEntity {
        ...
        public function toArray() : array {
            return array(
                ...
                "preferredExamDate" => isset($this->preferredExamDate) ? $this->preferredExamDate->format(WB_DATE_FORMAT) : "",
                "alternativeExamDate" => isset($this->alternativeExamDate) ? $this->alternativeExamDate->format(WB_DATE_FORMAT) : "",
